...
const ICONS = {
  ...
  sparkles:     ["M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"],
  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 24 }}>
        <div>
          <FieldLabel required tooltip="Enter your given name as it appears on your government-issued ID.">First Name</FieldLabel>
          <TextInput placeholder="Input First Name" value={data.firstName}
            onChange={e => set({ ...data, firstName: e.target.value })} />
        </div>
        <div>
          <FieldLabel required tooltip="Enter your family name or surname as it appears on your government-issued ID.">Last Name</FieldLabel>
      ...
      <FieldLabel required tooltip="Enter your current age in years.">Age</FieldLabel>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        <div>
          <FieldLabel required tooltip="Your current place of residence.">Current Address</FieldLabel>
        ...
        <div>
          <FieldLabel required tooltip="Your permanent home address as listed on official documents.">Permanent Address</FieldLabel>
      ...
      <FieldLabel required tooltip="Enter a valid Philippine mobile number (e.g. +63 912 345 6789).">Contact Number</FieldLabel>
      ...
      <FieldLabel required tooltip="Select the highest level of education you have completed.">Educational Attainment</FieldLabel>
      <SelectInput
...
const Step2 = ({ data, set }) => {
  const workSetups    = [{ icon: "home", label: "Remote" }, { icon: "wifi", label: "Hybrid" }, { icon: "building", label: "On-site" }];
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 14 }}>
        ...
        <InfoTooltip text="Select the industry sector you'd like to work in." />
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 14 }}>
        ...
        <InfoTooltip text="Select the employment arrangement you're looking for." />
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 14 }}>
        ...
        <InfoTooltip text="Select your expected monthly salary range in Philippine Pesos." />
      </div>
      <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
        {salaryRanges.map(r => (
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 14 }}>
        <SectionLabel>Your <strong style={{ color: T.teal }}>skills</strong></SectionLabel>
        <InfoTooltip text="Select all skills you are confident using professionally." />
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 14 }}>
        ...
        <InfoTooltip text="Let employers know your earliest available start date." />
      </div>
      ...
      <FieldLabel tooltip="Describe what kind of role, growth, or impact you are looking for in your next job.">
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 14 }}>
        ...
        <InfoTooltip text="Select all disability types that apply to you." />
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 14 }}>
        ...
        <InfoTooltip text="Indicate how your disability affects your daily work capacity." />
      </div>
        ...
        {severities.map(s => (
          <button key={s} onClick={() => set({ ...data, severity: s })}
            style={{ padding: "14px 10px", borderRadius: 12,
              ...
              fontSize: 14, fontWeight: data.severity === s ? 800 : 600,
      ...
      <FieldLabel tooltip="Your PWD ID number is issued by your local government. This is optional.">
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 14 }}>
        ...
        <InfoTooltip text="Select all adjustments or tools you need to perform your best at work." />
      </div>
      <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginBottom: 24 }}>
      ...
      <FieldLabel tooltip="Add any specific details about your condition or working arrangements.">
        Additional notes about your needs
      </FieldLabel>
      <TextArea
        placeholder="e.g. I need an ergonomic chair and occasional breaks every 2 hours..."
    ...
    <div>
      ...
      <div style={{ padding: "22px 24px", background: T.tealLight, borderRadius: 16, border: `2px solid ${T.teal}33` }}>
        ...
        {[
          ...
          "Privacy controls — disability disclosure fully optional",
        ].map(item => (
...
export default function OnboardingPage() {
  ...
  const handleLaunch = async () => {
    ...
    try {
      ...
      // Save to local storage layer
      storage.update({
        profile: {
          name: fullName, firstName: s1.firstName.trim(), lastName: s1.lastName.trim(),
          email: user.email || "", avatarInitials: initials,
          age: s1.age, address: s1.currentAddress, permanentAddress: s1.permanentAddress,
          contactNumber: s1.contactNumber, educationalAttainment: s1.educationalAttainment,
        },
        workPreference: { workType: s2.workType, contractType: s2.contractType, industry: s2.industry, salaryRange: s2.salaryRange, skills: s2.skills, availability: s2.availability, goals: s2.goals },
        disability: { types: s3.disabilityTypes, primaryType: s3.disabilityTypes[0] || "", severity: s3.severity, pwdId: s3.pwdId, accommodations: s3.accommodations, notes: s3.disabilityNotes, consentSharing: s3.consentSharing },
        dashboardPrefs: { theme: s4.theme, layout: s4.layout, widgets: s4.widgets },
