// Static data only - move all your constants here
...
export const JOB_LISTINGS = [
  { 
    ...
    address:"6750 Ayala Ave, BGC, Taguig, 1634",
    contactEmail:"pwd.hiring@accenture.com.ph", 
    contactPhone:"+63 2 8667 8000",
    setup:"Hybrid", 
    type:"Full-time", 
    salary:"₱25,000 – ₱40,000/mo",
    pwdFriendly:["visual","hearing","mobility","cognitive"],
    accommodations:[
      "Screen reader software provided",
  ...
  { 
    ...
    address:"BDO Corporate Center, 7899 Makati Ave",
    contactEmail:"inclusive.hiring@bdo.com.ph", 
    contactPhone:"+63 2 8840 7000",
    setup:"On-site", 
    type:"Full-time", 
  ...
  { 
    ...
    contactEmail:"diversity@teleperformance.ph", 
    contactPhone:"+63 2 8580 5000",
  ...
  { 
    ...
    address:"One World Place, BGC, Taguig",
    contactEmail:"inclusive@canva.ph", 
    contactPhone:"+63 2 7900 0000",
    setup:"Remote", 
    type:"Part-time", 
    ...
    requirements:[
      "Proficiency in Canva / Adobe tools",
  ...
  { 
    ...
    address:"10 F. Ortigas Jr. Road, Pasig City",
    contactEmail:"hr.inclusion@jfc.com.ph", 
  ...
  { 
    ...
    position:"QA Tester", 
    field:"tech",
    location:"Mandaluyong / Remote", 
    address:"Robinsons Cybergate, EDSA, Mandaluyong",
    contactEmail:"talent@sprout.ph", 
    contactPhone:"+63 2 8810 0000",
    setup:"Hybrid", 
    type:"Full-time", 
